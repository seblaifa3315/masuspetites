...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/TattooCarousel.tsx
  var TattooCarousel_exports = {};
  __export(TattooCarousel_exports, {
    Default: () => Default
  });
  init_define_import_meta_env();
  ...
  var images = [
    PLACEHOLDER_IMAGE,
    PLACEHOLDER_IMAGE_MUTED,
    PLACEHOLDER_IMAGE,
    PLACEHOLDER_IMAGE_MUTED,
    PLACEHOLDER_IMAGE
  ];
  var Default = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.TattooCarousel, { images });
  return __toCommonJS(TattooCarousel_exports);
})();
