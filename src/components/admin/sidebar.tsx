...
import { LayoutDashboard, Package, FileText, Users, MessageSquare, Calculator, Settings, ChevronsLeft } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/finances", label: "Finances", icon: Calculator },
